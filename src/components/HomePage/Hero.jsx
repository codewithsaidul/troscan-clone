    ...
    >
      ...
      <div className="max-w-4xl w-full text-center relative z-10">
        ...
        <div className="mt-8 flex max-md:flex-col flex-row justify-center gap-4">
          <Button className="py-4 px-6 bg-accent text-primary text-sm duration-700 hover:bg-accent/60 hover:duration-700 cursor-pointer">
            Our Vission
          </Button>
          <Button className="py-4 px-6 bg-transparent border border-accent text-accent text-sm duration-700 hover:bg-accent hover:text-primary hover:duration-700 cursor-pointer">
            Explore Experties
          </Button>
        </div>
      </div>
